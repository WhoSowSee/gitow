...
> - **Навигация по crates.io** - Открытие одного или нескольких указанных пакетов из любого каталога или чтение имени текущего пакета через Cargo с помощью `-x` или `--crates-io`.
